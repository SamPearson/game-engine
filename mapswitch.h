/*
*
* This .h file exists for one function, map_change()
* That function defines doors and collision boundaries in arrays
* as well as loading the background and sprite layers.
*
* Most of this file will be gone when the game is switched to a 
* tile-based system
*/
